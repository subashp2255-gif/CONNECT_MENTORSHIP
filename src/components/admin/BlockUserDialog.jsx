...
export default function BlockUserDialog({ isOpen, userId, onConfirm, onClose }) {
      ...
      <div className="bg-surface border border-border rounded-3xl p-6 w-full max-w-md shadow-2xl relative animate-scaleUp">
        ...
        <div className="flex justify-between items-start mb-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-bold text-white">Block User Account</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="bg-red-500/10 border border-red-500/20 p-4 rounded-xl text-xs text-red-400 flex items-start gap-2.5 mb-6">
          ...
          <div>
            ...
            <p className="mt-1 leading-relaxed">
              Blocking this user will instantly terminate their active sessions, prevent them from logging in, booking appointments, or messaging mentors.
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <textarea
              placeholder="Provide a detailed reason for blocking this user (e.g. Terms violation, report investigation)..."
              required
              rows={3}
              value={reason}
